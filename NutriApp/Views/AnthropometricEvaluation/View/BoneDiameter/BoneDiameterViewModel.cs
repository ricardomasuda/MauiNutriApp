...
public partial class BoneDiameterViewModel : BaseViewModel
{
    ...
    [ObservableProperty] private string _wrist;
    [ObservableProperty] private string _femur;
    [ObservableProperty] private bool _hasErrorHeight;
    [ObservableProperty] private bool _hasErrorWrist;
    [ObservableProperty] private bool _hasErrorFemur;
